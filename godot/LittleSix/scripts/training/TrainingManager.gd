...
func confirm_training_day() -> void:
	...
	var old_fatigue_level = get_fatigue_label(racer.fatigue)
	...
	var new_fatigue_level = get_fatigue_label(racer.fatigue)
	if old_fatigue_level != new_fatigue_level:
	    EventBus.fatigue_threshold_crossed.emit(old_fatigue_level, new_fatigue_level)
